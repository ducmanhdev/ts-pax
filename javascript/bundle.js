...
exports.REPORT_TRAN_TYPE = exports.PAYMENT_TRANS_TYPE = exports.PAX_EDC_TYPE = exports.PAX_CARD_TYPE = exports.ENTRY_MODE = void 0;
const PAX_CARD_TYPE = {
  ALL: "00",
  VISA: "01",
  MASTERCARD: "02",
...
exports.PAX_CARD_TYPE = PAX_CARD_TYPE;
const REPORT_TRAN_TYPE = {
...
exports.REPORT_TRAN_TYPE = REPORT_TRAN_TYPE;
const PAX_EDC_TYPE = {
  ALL: "00",
  CREDIT: "01",
  DEBIT: "02",
...
exports.PAX_EDC_TYPE = PAX_EDC_TYPE;
const PAYMENT_TRANS_TYPE = {
  TRAN_TYPE_MENU: '00',
  TRAN_TYPE_SALE: '01',
  TRAN_TYPE_RETURN: '02',
  TRAN_TYPE_AUTH: '03',
...
exports.PAYMENT_TRANS_TYPE = PAYMENT_TRANS_TYPE;
const ENTRY_MODE = {
...
var _reportRequest = _interopRequireDefault(require("./models/request/report-request"));
var _paxReportResponse = _interopRequireDefault(require("./models/response/pax-report-response"));
var _utils = require("./utils");
var _constants = require("./constants");
var _trackInfo = _interopRequireDefault(require("./models/request/track-info"));
var _paxResponse = _interopRequireDefault(require("./models/response/pax-response"));
var _amountInfo = _interopRequireDefault(require("./models/request/amount-info"));
...
class Pax {
  ...
  buildRequest({
    ...
    ///////// STEP 3
    let cmd = command + String.fromCharCode(28) + Pax.PROTO_VERSION + String.fromCharCode(28) + args_str + String.fromCharCode(3);
    cmd = String.fromCharCode(2) + cmd + (0, _utils.getLRC)(cmd);
    /////////////// END
  ...
  parseResponse(response) {
    ...
    const processResponse = (0, _utils.trim)(response, String.fromCharCode(2));
    const lrc = processResponse.split(String.fromCharCode(3));
    const expected = (0, _utils.getLRC)(response.substring(1, response.length - 1));
    ...
    return _paxResponse.default.fromString(lrc[0]);
  }
  parseReportResponse(response) {
    ...
    return _paxReportResponse.default.fromString(lrc[0]);
  }
  httpRequest(query) {
    var _a;
  ...
  makeCall({
    ...
    return new Promise(resolve => (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      try {
        ...
        _logger.default.info(`PAX REQUEST Query: [${this.host}/?${query}] - Command: [${command}] - DATA: [${args}]`);
        ...
        _logger.default.success(`PAX REQUEST Query: [${this.host}/?${query}] - RESPONSE: [${result}]`);
        const paxResponse = this.parseResponse(result);
        // console.log(paxResponse?.toString());
        _logger.default.success(`PAX REQUEST Query: [${this.host}/?${query}] - RESPONSE: [${paxResponse === null || paxResponse === void 0 ? void 0 : paxResponse.toString()}]`);
  ...
  makeCallReport({
    ...
    return new Promise(resolve => (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      try {
        ...
        _logger.default.success(`PAX REQUEST Query: [${this.host}/?${query}] - RESPONSE: [${paxReportResponse === null || paxReportResponse === void 0 ? void 0 : paxReportResponse.toString()}]`);
  ...
  doMenu() {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      return new Promise(resolve => (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
        const args = [_constants.PAYMENT_TRANS_TYPE.TRAN_TYPE_MENU, '', '', '1', '', '', '', '', ''];
        const response = yield this.makeCall({
          command: "T00",
          args: args
        });
        if (response !== null) {
          if (response.responseCode === "000000" && response.responseMessage === "OK") {
            return resolve(true);
          }
        }
  ...
  doSales({
    ...
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      _logger.default.info(`PAX REQUEST : [do_sales] - Order_ID: [${orderID}] - DATA: [Amount: ${amount} - tips: ${tips}]`);
      const amountRequest = new _amountInfo.default({
        transactionAmount: amount.toString(),
        tipAmount: tips === 0 || tips === null || isNaN(tips) ? '0' : tips.toString()
      });
      const traceRequest = new _trackInfo.default({
        invoiceNumber: orderID,
        referenceNumber: orderID
      });
      const args = [_constants.PAYMENT_TRANS_TYPE.TRAN_TYPE_SALE, amountRequest.toListData(), '', traceRequest.toListData(), '', '', '', '', ''];
  ...
  doAdjust({
    ...
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      _logger.default.info(`PAX REQUEST : [do_adjust] - Order_ID: [${reference}] - DATA: [tran_id: ${transaction} - tips: ${amount}]`);
      const amountRequest = new _amountInfo.default({
      ...
      const args = [_constants.PAYMENT_TRANS_TYPE.TRAN_TYPE_ADJUST, amountRequest.toListData(), '', traceRequest.toListData(), '', '', '', '', ''];
      return this.makeCall({
        command: "T00",
        args: args
      });
  ...
  doReturn(amount) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      _logger.default.info(`PAX REQUEST : [do_return] - DATA: [amount: ${amount}]`);
      const amountRequest = new _amountInfo.default({
        transactionAmount: amount.toString()
      });
      const traceRequest = new _trackInfo.default({});
      const args = [_constants.PAYMENT_TRANS_TYPE.TRAN_TYPE_RETURN, amountRequest.toListData(), '', traceRequest.toListData(), '', '', '', '', ''];
      return this.makeCall({
        command: "T00",
        args: args
      });
  ...
  doVoid({
    ...
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      _logger.default.info(`PAX REQUEST : [do_void] - Order_id: ${reference} DATA: [Tran_id: ${transaction}]`);
      const traceRequest = new _trackInfo.default({
        transactionNumber: transaction,
        referenceNumber: reference
      });
      const args = [_constants.PAYMENT_TRANS_TYPE.TRAN_TYPE_VOID, '', '', traceRequest.toListData(), '', '', '', '', ''];
      return this.makeCall({
        command: 'T00',
        args: args
      });
  ...
  localDetailReport(orderId) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function* () {
      ...
      // [03]C
      _logger.default.info(`PAX REQUEST : [local_detail_report] - Order_ID: [${orderId}]`);
      const reportRequest = new _reportRequest.default({
        edcType: _constants.PAX_EDC_TYPE.ALL,
        ecrRefNum: orderId
      });
      return this.makeCallReport({
        command: _constants.REPORT_TRAN_TYPE.LOCALDETAILREPORT,
...
},{"./constants":1,"./models/request/amount-info":3,"./models/request/report-request":4,"./models/request/track-info":5,"./models/response/pax-report-response":13,"./models/response/pax-response":14,"./utils":16,"./utils/logger":17,"axios":18,"tslib":63}],3:[function(require,module,exports){
"use strict";
...
class AmountInfo {
  ...
  toListData() {
    return [this.convertNumber(this.transactionAmount), this.convertNumber(this.tipAmount), '', '', '', ''];
  }
}
...
class ReportRequest {
  ...
  toListData() {
    return [this.edcType, this.cardType, this.paymentType, this.recordNum, this.refNum, this.authCode, this.ecrRefNum];
  }
}
...
class TrackInfo {
  ...
  toListData() {
    return [this.referenceNumber, this.invoiceNumber, this.authCode, this.transactionNumber, this.timeStamp, this.ecrTransId];
  }
}
...
exports.default = void 0;
var _batchCount = _interopRequireDefault(require("./batch-count"));
var _batchAmount = _interopRequireDefault(require("./batch-amount"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
class PaxBatchResponse {
  ...
  static fromList(data) {
    ...
    return new PaxBatchResponse({
      messageRaw: data[5],
      batchCount: _batchCount.default.fromString(data[6]),
      batchAmount: _batchAmount.default.fromString(data[7]),
      timestamp: data[8],
      tid: data[9],
      mid: data[10]
    });
...
},{"./batch-amount":8,"./batch-count":9}],12:[function(require,module,exports){
"use strict";
...
exports.default = void 0;
var _hostInformation = _interopRequireDefault(require("./host-information"));
var _traceInformation = _interopRequireDefault(require("./trace-information"));
var _amountInformation = _interopRequireDefault(require("./amount-information"));
var _accountInformation = _interopRequireDefault(require("./account-information"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
  ...
  static fromList(data) {
    ...
    */
    return new PaxPaymentResponse({
      ...
      hostInformation: _hostInformation.default.fromString(data[5]),
      transactionType: data[6],
      amountInformationRaw: data[7],
      amountInformation: _amountInformation.default.fromString(data[7]),
      accountInformationRaw: data[8],
      accountInformation: _accountInformation.default.fromString(data[8]),
      traceInformationRaw: data[9],
      traceInformation: _traceInformation.default.fromString(data[9]),
...
},{"./account-information":6,"./amount-information":7,"./host-information":10,"./trace-information":15}],13:[function(require,module,exports){
"use strict";
...
class PaxLocalDetailReport {
  ...
  static fromList(data) {
    ...
    return new PaxLocalDetailReport({
      ...
      hostInformation: _hostInformation.default.fromString(data[7]),
      edcType: data[8],
      paymentType: data[9],
      amountInformationRaw: data[11],
      amountInformation: _amountInformation.default.fromString(data[11]),
      accountInformationRaw: data[12],
      accountInformation: _accountInformation.default.fromString(data[12]),
      traceInformationRaw: data[13],
      traceInformation: _traceInformation.default.fromString(data[13]),
...
class PaxReportResponse {
  ...
  extraData() {
    if (this.command === PaxReportResponse.COMMAND_TYPE_REPORT_LOCAL_DETAIL_RESPONSE && this.paxLocalDetailReport != null) {
...
},{"./account-information":6,"./amount-information":7,"./host-information":10,"./trace-information":15}],14:[function(require,module,exports){
"use strict";
...
exports.default = void 0;
var _paxBatchResponse = _interopRequireDefault(require("./pax-batch-response"));
var _paxPaymentResponse = _interopRequireDefault(require("./pax-payment-response"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
class PaxResponse {
  constructor({
    status,
  ...
  static fromString(res) {
    ...
    if (fields.length >= 5) {
      ...
      // COMMAND PAX PAYMENT
      if (fields.length === 14 && command === PaxResponse.COMMAND_TYPE_PAYMENT) {
        const dataAmount = fields[7].split(String.fromCharCode(31));
        result.paxPaymentResponse = _paxPaymentResponse.default.fromList(fields);
        result.amount = parseInt(dataAmount[0]);
      } else if (fields.length === 12 && command === PaxResponse.COMMAND_TYPE_BATCH) {
        result.paxBatchResponse = _paxBatchResponse.default.fromList(fields);
      }
      // COMMAND PAX BATCH
      return result;
    }
...
exports.default = PaxResponse;
PaxResponse.COMMAND_TYPE_PAYMENT = "T01";
PaxResponse.COMMAND_TYPE_BATCH = "B01";
class PaxResponseCode {}

},{"./pax-batch-response":11,"./pax-payment-response":12}],15:[function(require,module,exports){
"use strict";
...
exports.trim = exports.stringToHex = exports.strEncodeUTF16 = exports.hexToString = exports.hexToBase64 = exports.getLRC = exports.base64ToHex = void 0;
...
const stringToHex = response => {
  ...
  for (let i = 0; i < response.length; i++) {
    if (responseHex === "") responseHex = response.charCodeAt(i).toString(16).length < 2 ? '0' + response.charCodeAt(i).toString(16) : response.charCodeAt(i).toString(16);else responseHex += response.charCodeAt(i).toString(16).length < 2 ? " " + '0' + response.charCodeAt(i).toString(16) : " " + response.charCodeAt(i).toString(16);
  }
  return responseHex;
};
...
},{"./lib/axios.js":21}],19:[function(require,module,exports){
"use strict";
...
},{"../core/AxiosError.js":26,"../utils.js":59,"./http.js":47,"./xhr.js":20}],20:[function(require,module,exports){
'use strict';
...
},{"../cancel/CanceledError.js":23,"../core/AxiosError.js":26,"../core/AxiosHeaders.js":27,"../core/buildFullPath.js":29,"../defaults/transitional.js":35,"../helpers/parseProtocol.js":49,"../helpers/speedometer.js":50,"../platform/index.js":58,"./../core/settle.js":32,"./../helpers/buildURL.js":40,"./../helpers/cookies.js":42,"./../helpers/isURLSameOrigin.js":46,"./../utils.js":59}],21:[function(require,module,exports){
'use strict';
...
},{"./cancel/CancelToken.js":22,"./cancel/CanceledError.js":23,"./cancel/isCancel.js":24,"./core/Axios.js":25,"./core/AxiosError.js":26,"./core/AxiosHeaders.js":27,"./core/mergeConfig.js":31,"./defaults/index.js":34,"./env/data.js":36,"./helpers/HttpStatusCode.js":38,"./helpers/bind.js":39,"./helpers/formDataToJSON.js":43,"./helpers/isAxiosError.js":45,"./helpers/spread.js":51,"./helpers/toFormData.js":52,"./utils.js":59}],22:[function(require,module,exports){
'use strict';
...
},{"./CanceledError.js":23}],23:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":26,"../utils.js":59}],24:[function(require,module,exports){
'use strict';
...
},{"../helpers/buildURL.js":40,"../helpers/validator.js":54,"./../utils.js":59,"./AxiosHeaders.js":27,"./InterceptorManager.js":28,"./buildFullPath.js":29,"./dispatchRequest.js":30,"./mergeConfig.js":31}],26:[function(require,module,exports){
'use strict';
...
},{"../utils.js":59}],27:[function(require,module,exports){
'use strict';
...
},{"../helpers/parseHeaders.js":48,"../utils.js":59}],28:[function(require,module,exports){
'use strict';
...
},{"./../utils.js":59}],29:[function(require,module,exports){
'use strict';
...
},{"../helpers/combineURLs.js":41,"../helpers/isAbsoluteURL.js":44}],30:[function(require,module,exports){
'use strict';
...
},{"../adapters/adapters.js":19,"../cancel/CanceledError.js":23,"../cancel/isCancel.js":24,"../core/AxiosHeaders.js":27,"../defaults/index.js":34,"./transformData.js":33}],31:[function(require,module,exports){
'use strict';
...
},{"../utils.js":59,"./AxiosHeaders.js":27}],32:[function(require,module,exports){
'use strict';
...
},{"./AxiosError.js":26}],33:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosHeaders.js":27,"../defaults/index.js":34,"./../utils.js":59}],34:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":26,"../helpers/formDataToJSON.js":43,"../helpers/toFormData.js":52,"../helpers/toURLEncodedForm.js":53,"../platform/index.js":58,"../utils.js":59,"./transitional.js":35}],35:[function(require,module,exports){
'use strict';
...
},{"./toFormData.js":52}],38:[function(require,module,exports){
"use strict";
...
},{"../helpers/AxiosURLSearchParams.js":37,"../utils.js":59}],41:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":58,"./../utils.js":59}],43:[function(require,module,exports){
'use strict';
...
},{"../utils.js":59}],44:[function(require,module,exports){
'use strict';
...
},{"./../utils.js":59}],46:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":58,"./../utils.js":59}],47:[function(require,module,exports){
"use strict";
...
},{"./../utils.js":59}],49:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":26,"../platform/node/classes/FormData.js":47,"../utils.js":59,"buffer":61}],53:[function(require,module,exports){
'use strict';
...
},{"../platform/index.js":58,"../utils.js":59,"./toFormData.js":52}],54:[function(require,module,exports){
'use strict';
...
},{"../core/AxiosError.js":26,"../env/data.js":36}],55:[function(require,module,exports){
'use strict';
...
},{"../../../helpers/AxiosURLSearchParams.js":37}],57:[function(require,module,exports){
"use strict";
...
},{"./classes/FormData.js":55,"./classes/URLSearchParams.js":56}],58:[function(require,module,exports){
"use strict";
...
},{"./helpers/bind.js":39}],60:[function(require,module,exports){
'use strict'
